...
```
├── assets/
│   ├── basics_preview.png      # Task 1 screenshot
│   ├── engine_preview.png      # Pivot tables & charts sheet
│   └── dashboard_preview.png   # Final dashboard
├── Basics_Task_Solution.xlsx   # Task 1 — Excel Fundamentals
...
- VLOOKUP table mapping Emp_ID → Full Name (lowercase & formatted)

![Task 1 — Excel Basics](assets/basics_preview.png)
...
![Engine Sheet](assets/engine_preview.png)

### Final Dashboard

![Sales Dashboard](assets/dashboard_preview.png)
